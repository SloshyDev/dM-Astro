  ...
  return (
    <li className={`${nested ? "group/nested" : "group"} relative`}>
      <button
        ...
        <p className="menu_link whitespace-nowrap">{label}</p>

        <Icon name="chevronDown" className={`size-5 mb-1 ml-1 text-teal-700 transition-transform dark:text-teal-300 ${arrowClass}`} />
      </button>
